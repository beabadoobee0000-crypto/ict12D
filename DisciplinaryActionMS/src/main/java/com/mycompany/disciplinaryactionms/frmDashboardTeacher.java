...
String selectedStatus = "All";
    ...
    //private void displayImage(String path) {
       ...
       // catch (Exception e) {
        ...
        tblRecords.getTableHeader().setBackground(new Color(37, 99, 235));
...
lblInactiveNum.setFont(new Font("Arial", Font.BOLD, 24));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        frmDashboardTeacher w = new frmDashboardTeacher();
        w.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        frmMonthlyRecordTeacher ss = new frmMonthlyRecordTeacher();
        ss.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDashboardTeacher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
